...
<div ng-controller="laundryController" ng-init="getPrice();">
				...
				<form name="form" enctype="text/plain" id="Form" novalidate="novalidate">
					...
					<div ng-if="form.$valid" ng-style="{visibility: (form.$valid) ? 'visible':'hidden'}">
						...
						<div ng-show="quote_gotten" style="padding: 20px 20px;">
							...
							<button id="Button1" name="pay" style="position:absolute;left:18px;top:797px;width:319px;height:47px;z-index:21;" 
					...
					<div ng-hide="quote_gotten">
						...
						<select name="month" size="1" id="Combobox1" required
							style="position:absolute;left:20px;top:488px;width:140px;height:35px;z-index:23;" ng-model="order.month">
						...
						<select name="hour" size="1" id="Combobox4" required
							style="position:absolute;left:21px;top:527px;width:140px;height:35px;z-index:24;" ng-model="order.hour">
						...
						<select name="day" size="1" id="Combobox2" required
							style="position:absolute;left:164px;top:488px;width:79px;height:35px;z-index:25;" ng-model="order.day">
							<option value="1">1</option>
							<option value="2">2</option>
							<option value="3">3</option>
							<option value="4">4</option>
						...
						<select name="minute" size="1" id="Combobox5" required
							style="position:absolute;left:164px;top:527px;width:79px;height:35px;z-index:26;" ng-model="order.minute">
							<option value="00" ng-selected="true">00</option>
							<option value="15">15</option>
							<option value="30">30</option>
							<option value="45">45</option>
						</select>
						<select name="year" size="1" id="Combobox3" required
							style="position:absolute;left:247px;top:487px;width:88px;height:35px;z-index:27;" ng-model="order.year">
						...
						<select name="period" size="1" id="Combobox6" required
							style="position:absolute;left:248px;top:526px;width:88px;height:35px;z-index:28;" ng-model="order.period">
