			...
			<div id="wb_Form1" style="position:absolute;left:526px;top:62px;width:343px;height:707px;z-index:27;">
				<form name="form" method="post" enctype="text/plain" novalidate>
					<div ng-hide="quote_gotten">
						...
						<textarea name="TextArea2" id="TextArea2" required ng-model="order.details"
							style="position:absolute;left:15px;top:504px;width:299px;height:90px;z-index:11;" rows="4" cols="47" placeholder="Please describe the job in details">
						</textarea>
						...
						<textarea name="TextArea1" id="TextArea1" required ng-model="order.address"
							style="position:absolute;left:15px;top:396px;width:300px;height:90px;z-index:17;" rows="4" cols="47" placeholder="Address">
						</textarea>

						<select name="month" ng-model="order.month" size="1" id="Combobox1" style="position:absolute;left:10px;top:315px;width:140px;height:35px;z-index:19;" required>
						...
						<select name="hour" ng-model="order.hour" size="1" id="Combobox4" style="position:absolute;left:11px;top:354px;width:140px;height:35px;z-index:20;" required>
						...
						<select name="day" ng-model="order.day" size="1" id="Combobox2" style="position:absolute;left:154px;top:315px;width:79px;height:35px;z-index:21;" required>
							<option value="1">1</option>
							<option value="2">2</option>
							<option value="3">3</option>
							<option value="4">4</option>
						...
						<select name="minute" ng-model="order.minute" size="1" id="Combobox5" style="position:absolute;left:154px;top:354px;width:79px;height:35px;z-index:22;" required>
						...
						<select name="period" size="1" id="Combobox6" style="position:absolute;left:237px;top:316px;width:88px;height:35px;z-index:23;" ng-model="order.period" required>
							<option value="am">am</option>
							<option value="pm">pm</option>
						</select>

						<select name="year" size="1" id="Combobox3" style="position:absolute;left:237px;top:354px;width:88px;height:35px;z-index:24;" ng-model="order.year" required>
