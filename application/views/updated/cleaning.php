...
<div ng-controller="cleaningController" ng-init="getPrice('<?=base_url();?>');">
	<div id="Layer2" style="position:relative;text-align:center;margin:0px 0px 0px 0px;width:100%;height:998px;float:left;clear:left;display:block;z-index:56;">
		<div id="Layer2_Container" style="width:1237px;height:998px;position:relative;margin-left:auto;margin-right:auto;margin-top:auto;margin-bottom:auto;text-align:left;">
			...
			<div id="wb_Text1" style="position:absolute;left:357px;top:307px;width:104px;height:58px;z-index:24;text-align:left;">
				<span style="color:#696969;font-family:Arial;font-size:24px;">
					<strong>Cleaning</strong>
				</span>
			</div>
			<div id="wb_Form1" style="position:absolute;left:518px;top:30px;width:356px;height:655px;z-index:25;">
				<form name="form" method="post" novalidate="">
					...
					<div ng-hide="quote_gotten">
						...
						<label for="RadioButton2" id="Label2" style="position:absolute;left:15px;top:82px;width:114px;height:18px;line-height:18px;z-index:6;"> Office Cleaning</label>
						<input type="radio" ng-model="order.type" name="type" value="office cleaning" style="position:absolute;left:158px;top:84px;z-index:7;" >
						...
						<select name="hour" ng-model="order.hour" size="1" id="Combobox4" style="position:absolute;left:14px;top:320px;width:140px;height:35px;z-index:18;">
						...
						<select name="day" ng-model="order.day" size="1" id="Combobox2" style="position:absolute;left:157px;top:281px;width:79px;height:35px;z-index:19;">
							<option value="1">1</option>
							<option value="2">2</option>
							<option value="3">3</option>
							<option value="4">4</option>
						...
						<select name="minute" ng-model="order.minute" size="1" id="Combobox5" style="position:absolute;left:157px;top:320px;width:79px;height:35px;z-index:20;">
							<option value="00" ng-selected="true">00</option>
							<option value="15">15</option>
							<option value="30">30</option>
							<option value="45">45</option>
						</select>
						<select name="year" ng-model="order.year" size="1" id="Combobox3" style="position:absolute;left:240px;top:281px;width:85px;height:35px;z-index:21;">
						...
						<select name="period" ng-model="order.period" size="1" id="Combobox6" style="position:absolute;left:241px;top:320px;width:85px;height:35px;z-index:22;">
					...
					<div ng-if="form.$valid" style="visibility: hidden;" ng-style="{visibility: (form.$valid) ? 'visible':'hidden'}">
						...
						<div ng-show="quote_gotten" style="padding: 20px 20px;">
							...
							<hr>
							<table width="100%">
								<tr ng-if="order.rooms > 0" height="40px">
									<th>Rooms</th>
									<td>{{ order.rooms }}</td>
								</tr>
							</table>
			...
			<div id="wb_Image2" style="position:absolute;left:282px;top:353px;width:210px;height:210px;z-index:26;">
				<img src="<?=base_url('assets/last_design/images/');?>FD-2017_vacuum-copy.png" id="Image2" alt="">
			</div>
		</div>
	</div>
</div>
