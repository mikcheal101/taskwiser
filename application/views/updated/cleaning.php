			...
			<div id="wb_Form1" >
				<form name="form" method="post" novalidate="">
					...
					<div ng-hide="quote_gotten">
						...
						<label for="RadioButton1" id="Label1"> House Cleaning</label>
						<input type="radio" id="RadioButton1"  ng-model="order.type" name="type" value="house cleaning">

						<label for="RadioButton2" id="Label2"> Office Cleaning</label>
						<input type="radio" id="RadioButton2"  ng-model="order.type" name="type" value="office cleaning">
						...
						<label for="Shape2" id="Label6">Number of rooms</label>
						<input type="text" id="Editbox4" ng-model="order.rooms" required name="rooms" value="0">

						<textarea name="TextArea1" id="TextArea1" rows="4" cols="47"
							placeholder="Address" ng-model="order.address" required>
						</textarea>
						<textarea name="TextArea2" id="TextArea2" rows="4" cols="47"
