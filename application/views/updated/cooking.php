...
<div ng-controller="cookingController" ng-init="getPrice();">
			...
			<div id="wb_Form1" style="position:absolute;left:506px;top:64px;width:345px;height:639px;z-index:23;">
				<form name="form" method="post" novalidate="">
					...
					<div ng-hide="quote_gotten">
						...
						<input type="text" id="Editbox3" style="position:absolute;left:15px;top:241px;width:300px;height:25px;line-height:18px;z-index:12;" ng-model="order.boxes" required name="boxes" value="0">
