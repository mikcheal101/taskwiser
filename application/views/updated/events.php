...
<div ng-controller="eventsController" ng-init="getPrice('<?=base_url();?>');">
	<div id="Layer2">
			...
			<div id="wb_Form1">
				<form name="form" method="post" novalidate="">
					...
					<div ng-hide="quote_gotten">
						...
						<label for="Label1" id="Label1"> Photographer</label>
						<input type="radio" id="RadioButton1" ng-model="order.type" name="type" value="photographer">
						...
						<textarea name="TextArea2" id="TextArea2" rows="4" cols="47" ng-model="order.details"
						...
						<label for="Combobox6" id="Label6"> Select Duration</label>
						<select ng-model="order.duration" name=" date and year" size="1" id="Combobox7">
