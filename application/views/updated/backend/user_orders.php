...
<link href="_user_orders.css" rel="stylesheet">
</head>
<body>
<div id="Layer1" style="position:relative;text-align:left;margin:0px 0px 0px 0px;width:100%;height:68px;float:left;clear:left;display:block;z-index:28;">
<div id="wb_Image1" style="position:absolute;left:92px;top:7px;width:151px;height:54px;z-index:0;">
...
<span style="color:#696969;font-family:Arial;font-size:13px;"> Welcome to your dash board, you can view your orders and services requested.Should you wish to cancel an order, please give us a 6 hours prior notification. </span></div>
...
<a href="./_book_now.html"><img src="images/img0036.png" id="Shape1" alt="" style="width:183px;height:35px;"></a></div>
