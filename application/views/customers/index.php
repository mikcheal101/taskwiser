...
<body ng-app="app" style="overflow-x:hidden;">
	...
	<div id="Layer1" style="position:relative;text-align:center;margin:0px 0px 0px 0px;width:100%;height:100%;float:left;display:block;z-index:51;">
		<div id="Layer1_Container" style="width:1278px;position:relative;margin-left:auto;margin-right:auto;text-align:left;">
			...
			<div id="wb_Text25" style="position:absolute;left:264px;top:66px;width:143px;height:16px;z-index:2;text-align:left;">
				<span style="color:#FFFFFF;font-family:Arial;font-size:13px;"> Select Your Location</span>
			</div>
			<select name=" date and year" size="1" id="Combobox1" style="position:absolute;left:405px;top:56px;width:171px;height:35px;z-index:3;">
				<option>lagos</option>
				<option>abuja</option>
				<option>portharcourt</option>
				<option>Enugu</option>
			</select>
			<div id="wb_Text23" style="position:absolute;left:637px;top:64px;width:59px;height:18px;z-index:4;text-align:left;">
				<span style="color:#FFFFFF;font-family:Arial;font-size:16px;"> Sign in</span>
			</div>
			<div id="wb_Text24" style="position:absolute;left:793px;top:64px;width:80px;height:18px;z-index:5;text-align:left;">
				<span style="color:#FFFFFF;font-family:Arial;font-size:16px;"> Book Now</span>
			</div>
			<div id="wb_Shape5" style="position:absolute;left:656px;top:581px;width:37px;height:22px;z-index:6;">
				<img src="<?=base_url('assets/last_design/images/');?>/img0043.png" id="Shape5" alt="" style="width:37px;height:22px;">
			</div>
		</div>
	</div>
	<div id="Layer2" style="position:relative;text-align:center;margin:0px 0px 0px 0px;width:100%;height:100%;float:left;display:block;z-index:52;">
		<div id="Layer2_Container" style="width:1280px;position:relative;margin-left:auto;margin-right:auto;text-align:left;">
		</div>
	</div>
	<div id="Layer3" style="position:relative;text-align:center;margin:0px 0px 0px 0px;width:100%;height:704px;float:left;clear:left;display:block;z-index:53;">
		<div id="Layer3_Container" style="width:1278px;position:relative;margin-left:auto;margin-right:auto;text-align:left;">
			<div id="wb_Image4" style="position:absolute;left:975px;top:380px;width:62px;height:62px;z-index:7;">
				<img src="<?=base_url('assets/last_design/images/');?>/reliable.png" id="Image4" alt="">
			</div>
			<div id="wb_Image5" style="position:absolute;left:655px;top:365px;width:56px;height:64px;z-index:8;">
				<img src="<?=base_url('assets/last_design/images/');?>/trusted.png" id="Image5" alt="">
			</div>
			<div id="wb_Image3" style="position:absolute;left:655px;top:86px;width:77px;height:74px;z-index:9;">
				<img src="<?=base_url('assets/last_design/images/');?>/guaranteed.png" id="Image3" alt="">
			</div>
			<div id="wb_Image2" style="position:absolute;left:975px;top:104px;width:62px;height:56px;z-index:10;">
				<img src="<?=base_url('assets/last_design/images/');?>/convenient.png" id="Image2" alt="">
			</div>
			<div id="wb_Text2" style="position:absolute;left:655px;top:180px;width:245px;height:139px;z-index:11;text-align:left;">
				<div>
			...
			<div id="wb_Text3" style="position:absolute;left:979px;top:180px;width:211px;height:123px;z-index:12;text-align:left;">
				<span style="color:#696969;font-family:Arial;font-size:19px;">
			...
			<div id="wb_Text4" style="position:absolute;left:655px;top:458px;width:235px;height:139px;z-index:13;text-align:left;">
				<span style="color:#696969;font-family:Arial;font-size:19px;">
			...
			<div id="wb_Text5" style="position:absolute;left:979px;top:458px;width:184px;height:123px;z-index:14;text-align:left;">
				<span style="color:#696969;font-family:Arial;font-size:19px;">
			...
			<div id="wb_Line1" style="position:absolute;left:547px;top:58px;width:4px;height:558px;z-index:15;">
				<img src="<?=base_url('assets/last_design/images/');?>/img0001.png" id="Line1" alt="">
			</div>
			<div id="wb_Text1" style="position:absolute;left:91px;top:179px;width:337px;height:201px;z-index:16;text-align:left;">
		...
		<div id="Layer4_Container" style="width:1278px;position:relative;margin-left:auto;margin-right:auto;text-align:left;">
			...
			<div id="wb_Image12" style="position:absolute;left:81px;top:353px;width:103px;height:69px;z-index:21;">
				<a href="<?=base_url('place_order/delivery');?>">
					<img src="<?=base_url('assets/last_design/images/');?>deliver.png" id="Image12" alt="">
				</a>
			</div>
			...
			<div id="wb_Text6" style="position:absolute;left:516px;top:62px;width:100%;height:47px;z-index:28;text-align:left;">
			...
			<div id="wb_Text16" style="position:absolute;left:518px;top:424px;width:97px;height:17px;z-index:37;text-align:left;">
				<span style="color:#FFFFFF;font-family:'Segoe UI';font-size:13px;"> Auto Repair</span>
			</div>
	...
	<div id="Layer5" style="position:relative;text-align:center;margin:0px 0px 0px 0px;width:100%;height:55px;float:left;clear:left;display:block;z-index:54;">
		<div id="Layer5_Container" style="width:1278px;position:relative;margin-left:auto;margin-right:auto;text-align:left;">
			...
			<div id="wb_Shape1" style="position:absolute;left:59px;top:8px;width:183px;height:35px;z-index:44;">
				<a href="<?=base_url('');?>_book_now.html">
