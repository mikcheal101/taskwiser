						...
						<?php
							for ($j=1; $j<=4; $j++) {
								...
								if (intval($k) < intval(count($categories))) {
									...
									?>
									<div class="p-b-2 col-sm-3 text-center t-icons" data-toggle="modal" data-target="#<?=$category['_id'];?>" style="padding-bottom:70px!important;" data-id="<?=$category['_id'];?>" data-backdrop="static">
